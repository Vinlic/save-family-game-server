...
var Conversation = class _Conversation {
  ...
  constructor(options) {
    ...
    this.messages = _14.defaultTo(options.messages, []);
...
var Ticket = class _Ticket {
  ...
  constructor(options = {}) {
    ...
    this.ticketId = _15.defaultTo(id, util_default.uuid());
  ...
  toMaskedData() {
    return _15.omit(this, "ipAddress", "oldIPAddresses", "ipAddressSwitchTimeIntervals");
  }
};
...
var ticket_default2 = {
  ...
  post: {
    "/create": async (request) => {
      ...
      request.validate("body.username", _17.isString);
